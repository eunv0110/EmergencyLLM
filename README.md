...
- 🔹 **2022년 응급실 내원 환자 중증도 분류 결과**: 전체 응급실 내원 환자 중 46.6%가 경증 또는 비응급 환자인 것으로 나타남
...
- **중증 응급환자**: 중증도 분류결과 1등급 및 2등급
- **중증 응급의심환자**: 중증도 분류결과 3등급
- **경증 응급환자 및 비응급환자**: 중증도 분류결과 4등급 및 5등급
...
- **4~5등급 판정 시**: 응급상황이 아닌 것으로 판단하며, 증상 악화 시 응급실 이동 권고
